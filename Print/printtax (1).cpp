...
{
    QDir d;
    QString fileName = QString("tax_%1.json").arg(fInvoice);
    ...
    if (f.open(QIODevice::WriteOnly)) {
        f.write(QString("{\"seq\":1,\"paidAmount\":%1, \"paidAmountCard\":%2, \"partialAmount\":0, "
                 ...
                 .arg(float_str(fAmountCash.toDouble(), 2))
                 .arg(float_str(fAmountCard.toDouble(), 2))
                 .arg(float_str(fAmountPre.toDouble(), 2)).toUtf8());
        bool first = true;
        for (int i = 0; i < fCodeList.count(); i++) {
            ...
            f.write(QString("{\"dep\":%1,\"qty\":%2,\"price\":%3, \"totalPrice\":%4, "
                    ...
                    .arg(fQtyList.at(i))
                    .arg(fPriceList.at(i))
                    .arg(float_str(fQtyList.at(i).toDouble() * fPriceList.at(i).toDouble(), 2))
                    .arg(fCodeList.at(i))
                    .arg(fTaxNameList.at(i))
                    .arg(fAdgCode.at(i))
