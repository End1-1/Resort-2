...
public:
    ...
    QToolButton *btnConnectionStatus;
    QToolButton *btnHallWash;
    QToolButton *btnHallCafe;
    QToolButton *btnHallVIP;
    QToolButton *btnShop;
    QLabel *lbStaff;
    QLabel *lbCar;
    ...
    void setupUi(QDialog *RDesk)
    {
        ...
        btnConnectionStatus = new QToolButton(widget_4);
        btnConnectionStatus->setObjectName(QString::fromUtf8("btnConnectionStatus"));
        btnConnectionStatus->setMinimumSize(QSize(40, 40));
        btnConnectionStatus->setMaximumSize(QSize(200, 40));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/wifi_off.png"), QSize(), QIcon::Normal, QIcon::Off);
        btnConnectionStatus->setIcon(icon);
        btnConnectionStatus->setIconSize(QSize(32, 32));

        horizontalLayout_6->addWidget(btnConnectionStatus);

        btnHallWash = new QToolButton(widget_4);
        btnHallWash->setObjectName(QString::fromUtf8("btnHallWash"));
        ...
        btnHallCafe->setObjectName(QString::fromUtf8("btnHallCafe"));
        btnHallCafe->setMinimumSize(QSize(200, 40));
        btnHallCafe->setMaximumSize(QSize(200, 40));

        horizontalLayout_6->addWidget(btnHallCafe);

        btnHallVIP = new QToolButton(widget_4);
        btnHallVIP->setObjectName(QString::fromUtf8("btnHallVIP"));
        btnHallVIP->setMinimumSize(QSize(200, 40));
        btnHallVIP->setMaximumSize(QSize(200, 40));

        horizontalLayout_6->addWidget(btnHallVIP);

        btnShop = new QToolButton(widget_4);
        btnShop->setObjectName(QString::fromUtf8("btnShop"));
        btnShop->setMinimumSize(QSize(200, 40));
        btnShop->setMaximumSize(QSize(200, 40));

        horizontalLayout_6->addWidget(btnShop);
        ...
        lbCar->setObjectName(QString::fromUtf8("lbCar"));
        ...
        btnExit_2->setObjectName(QString::fromUtf8("btnExit_2"));
        btnExit_2->setMinimumSize(QSize(80, 50));
        btnExit_2->setFocusPolicy(Qt::NoFocus);
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/images/discount.png"), QSize(), QIcon::Normal, QIcon::Off);
        btnExit_2->setIcon(icon1);
        ...
        tblTables->setVerticalScrollBarPolicy(Qt::ScrollBarAlwaysOn);
        ...
        btnSetCar->setObjectName(QString::fromUtf8("btnSetCar"));
        btnSetCar->setMinimumSize(QSize(50, 50));
        btnSetCar->setMaximumSize(QSize(50, 50));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/Resort/images/car.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/images/transfer.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/images/printer.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/images/garbage.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        if (tblTotal->rowCount() < 3)
            tblTotal->setRowCount(3);
        ...
        tblTotal->setVerticalHeaderItem(2, __qtablewidgetitem28);
        QTableWidgetItem *__qtablewidgetitem29 = new QTableWidgetItem();
        tblTotal->setItem(0, 0, __qtablewidgetitem29);
        QTableWidgetItem *__qtablewidgetitem30 = new QTableWidgetItem();
        tblTotal->setItem(0, 1, __qtablewidgetitem30);
        QTableWidgetItem *__qtablewidgetitem31 = new QTableWidgetItem();
        tblTotal->setItem(1, 0, __qtablewidgetitem31);
        QTableWidgetItem *__qtablewidgetitem32 = new QTableWidgetItem();
        tblTotal->setItem(1, 1, __qtablewidgetitem32);
        QTableWidgetItem *__qtablewidgetitem33 = new QTableWidgetItem();
        tblTotal->setItem(2, 0, __qtablewidgetitem33);
        tblTotal->setObjectName(QString::fromUtf8("tblTotal"));
        tblTotal->setMinimumSize(QSize(0, 90));
        tblTotal->setMaximumSize(QSize(16777215, 90));
        ...
        btnPayment_2->setObjectName(QString::fromUtf8("btnPayment_2"));
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/images/wallet-with-money.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QDialog *RDesk)
    {
        ...
        btnConnectionStatus->setText(QCoreApplication::translate("RDesk", "CAFE", nullptr));
        btnHallWash->setText(QCoreApplication::translate("RDesk", "WASH", nullptr));
        btnHallCafe->setText(QCoreApplication::translate("RDesk", "CAFE", nullptr));
        btnHallVIP->setText(QCoreApplication::translate("RDesk", "VIP", nullptr));
        btnShop->setText(QCoreApplication::translate("RDesk", "SHOP", nullptr));
        lbStaff->setText(QCoreApplication::translate("RDesk", "Staff", nullptr));
        lbCar->setText(QCoreApplication::translate("RDesk", "Car", nullptr));
        btnExit_2->setText(QCoreApplication::translate("RDesk", "-20%", nullptr));
        ...
        ___qtablewidgetitem5->setText(QCoreApplication::translate("RDesk", "New Row", nullptr));
        ...
        ___qtablewidgetitem7->setText(QCoreApplication::translate("RDesk", "New Column", nullptr));
        ...
        ___qtablewidgetitem8->setText(QCoreApplication::translate("RDesk", "Item name", nullptr));
        QTableWidgetItem *___qtablewidgetitem9 = tblOrder->horizontalHeaderItem(1);
        ___qtablewidgetitem9->setText(QCoreApplication::translate("RDesk", "Qty", nullptr));
        QTableWidgetItem *___qtablewidgetitem10 = tblOrder->horizontalHeaderItem(2);
        ___qtablewidgetitem10->setText(QCoreApplication::translate("RDesk", "Amount", nullptr));
        QTableWidgetItem *___qtablewidgetitem11 = tblComplex->horizontalHeaderItem(0);
        ___qtablewidgetitem11->setText(QCoreApplication::translate("RDesk", "ItemCode", nullptr));
        QTableWidgetItem *___qtablewidgetitem12 = tblComplex->horizontalHeaderItem(1);
        ___qtablewidgetitem12->setText(QCoreApplication::translate("RDesk", "ItemName", nullptr));
        QTableWidgetItem *___qtablewidgetitem13 = tblComplex->horizontalHeaderItem(2);
        ___qtablewidgetitem13->setText(QCoreApplication::translate("RDesk", "Qty", nullptr));
        QTableWidgetItem *___qtablewidgetitem14 = tblComplex->horizontalHeaderItem(3);
        ___qtablewidgetitem14->setText(QCoreApplication::translate("RDesk", "Amount", nullptr));
        QTableWidgetItem *___qtablewidgetitem15 = tblTotal->horizontalHeaderItem(0);
        ___qtablewidgetitem15->setText(QCoreApplication::translate("RDesk", "Key", nullptr));
        QTableWidgetItem *___qtablewidgetitem16 = tblTotal->horizontalHeaderItem(1);
        ___qtablewidgetitem16->setText(QCoreApplication::translate("RDesk", "Value", nullptr));
        ...
        ___qtablewidgetitem18->setText(QCoreApplication::translate("RDesk", "New Row", nullptr));
        QTableWidgetItem *___qtablewidgetitem19 = tblTotal->verticalHeaderItem(2);
        ___qtablewidgetitem19->setText(QCoreApplication::translate("RDesk", "New Row", nullptr));

        const bool __sortingEnabled1 = tblTotal->isSortingEnabled();
        tblTotal->setSortingEnabled(false);
        QTableWidgetItem *___qtablewidgetitem20 = tblTotal->item(0, 0);
        ___qtablewidgetitem20->setText(QCoreApplication::translate("RDesk", "Table", nullptr));
        QTableWidgetItem *___qtablewidgetitem21 = tblTotal->item(0, 1);
        ___qtablewidgetitem21->setText(QCoreApplication::translate("RDesk", "Seghan1", nullptr));
        QTableWidgetItem *___qtablewidgetitem22 = tblTotal->item(1, 0);
        ___qtablewidgetitem22->setText(QCoreApplication::translate("RDesk", "Total", nullptr));
        QTableWidgetItem *___qtablewidgetitem23 = tblTotal->item(1, 1);
        ___qtablewidgetitem23->setText(QCoreApplication::translate("RDesk", "0", nullptr));
