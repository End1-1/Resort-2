...
#include <memory>
#include "../../Restaurant2/dlgcarselection.h"
...
void DlgCarSelection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DlgCarSelection *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject DlgCarSelection::staticMetaObject = { {
    QMetaObject::SuperData::link<BaseExtendedDialog::staticMetaObject>(),
    qt_meta_stringdata_DlgCarSelection.data,
    qt_meta_data_DlgCarSelection,
    qt_static_metacall,
    nullptr,
    nullptr
} };
