...
#include <memory>
#include "../../Resort/broadcastthread.h"
...
void BroadcastThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BroadcastThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject BroadcastThread::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_BroadcastThread.data,
    qt_meta_data_BroadcastThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
