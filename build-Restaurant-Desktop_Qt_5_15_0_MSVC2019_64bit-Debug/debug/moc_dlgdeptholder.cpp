...
#include <memory>
#include "../../Restaurant2/dlgdeptholder.h"
...
void DlgDeptHolder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DlgDeptHolder *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject DlgDeptHolder::staticMetaObject = { {
    QMetaObject::SuperData::link<BaseExtendedDialog::staticMetaObject>(),
    qt_meta_stringdata_DlgDeptHolder.data,
    qt_meta_data_DlgDeptHolder,
    qt_static_metacall,
    nullptr,
    nullptr
} };
