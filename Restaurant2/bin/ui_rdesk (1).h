...
public:
    ...
    void setupUi(QDialog *RDesk)
    {
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/images/box.png"), QSize(), QIcon::Normal, QIcon::Off);
        btnPackage->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/Resort/images/car.png"), QSize(), QIcon::Normal, QIcon::Off);
        btnSetCar->setIcon(icon3);
        ...
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/images/transfer.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/images/garbage.png"), QSize(), QIcon::Normal, QIcon::Off);
        btnTrash->setIcon(icon7);
        ...
        QIcon icon8;
        icon8.addFile(QStringLiteral(":/images/invoice.png"), QSize(), QIcon::Normal, QIcon::Off);
        btnPayment_2->setIcon(icon8);
        ...
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/images/wallet-with-money.png"), QSize(), QIcon::Normal, QIcon::Off);
        btnPayment->setIcon(icon9);
