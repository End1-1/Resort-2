...
public:
    ...
    void setupUi(QDialog *DlgCarSelection)
    {
        ...
        DlgCarSelection->resize(642, 262);
        ...
        leVisit = new QLineEdit(frame);
        leVisit->setObjectName(QStringLiteral("leVisit"));
        leVisit->setReadOnly(true);

        gridLayout->addWidget(leVisit, 2, 1, 1, 2);
    ...
    void retranslateUi(QDialog *DlgCarSelection)
    {
        ...
        label_3->setText(QApplication::translate("DlgCarSelection", "Visits", nullptr));
